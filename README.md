...
- Trained and optimized ensemble models including Random Forest and Gradient Boosting using cross
validation and hyperparameter tuning.
- Prioritized high recall to proactively flag at-risk drivers and interpreted feature importance to
generate actionable retention insights for business stakeholders.
***Tech Stack: Python, Pandas, NumPy, Scikit-learn,Ensemble model***
